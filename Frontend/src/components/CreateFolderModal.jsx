          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-blue-600 text-white rounded-xl text-[14px] font-medium hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
